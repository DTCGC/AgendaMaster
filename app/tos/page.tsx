  ...
  return (
    <div className="flex-1 bg-background py-16 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold text-brand-loyal-blue mb-8 border-b pb-4">Terms of Service</h1>
        ...
        <p className="text-slate-700 mb-10 leading-relaxed font-medium">
          By accessing or using the AgendaMaster portal at <span className="font-bold text-brand-loyal-blue">agendas.coquitlamgavel.com</span>, 
          you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the application.
        </p>

        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-brand-loyal-blue mb-4">1. Use of Service</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-brand-loyal-blue mb-4">2. Intellectual Property</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-brand-loyal-blue mb-4">3. Accuracy of Information</h2>
          <p className="text-slate-700">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-brand-loyal-blue mb-4">4. Privacy</h2>
          <p className="text-slate-700">
            Your use of AgendaMaster is also governed by our <Link href="/privacy" className="text-brand-loyal-blue hover:underline font-medium">Privacy Policy</Link>, 
            which is incorporated into these Terms by reference.
          </p>
        </section>

        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-brand-loyal-blue mb-4">5. Limitation of Liability</h2>
          <p className="text-slate-700">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-brand-loyal-blue mb-4">6. Changes to Terms</h2>
          <p className="text-slate-700">
        ...
        <section className="mb-10 text-center bg-slate-50 p-8 rounded-lg border border-slate-200">
          <h2 className="text-xl font-bold text-brand-loyal-blue mb-2">Contact Us</h2>
