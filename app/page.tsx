    ...
    <div className="flex-1 flex flex-col items-center p-6 bg-brand-cool-grey/20 relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full z-10">
        ...
        <div className="min-h-[85vh] flex flex-col justify-center items-center text-center space-y-8 py-12">
          ...
          <div className="pt-10 animate-pulse text-brand-loyal-blue/40 flex flex-col items-center gap-2 text-xs font-bold tracking-widest uppercase">
        ...
        <section className="pt-24 pb-20 border-t border-gray-200">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl font-bold text-brand-loyal-blue mb-4">Data Transparency</h2>
            <p className="text-sm text-gray-600 leading-relaxed mb-8 px-4">
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-[10px] font-bold uppercase tracking-[0.2em] text-brand-loyal-blue/50">
